...
{
    [TestFixture]
    public class ATSTransitionServiceTests
    {
        private Mock<ITranstionHandler> _transtionHandlerMock;
        private ATSTransitionService _atsTransitionService;
        ...
        public void Setup()
        {
            ...
            _atsTransitionService = new ATSTransitionService(_transtionHandlerMock.Object
        ...
        public async Task ExecuteTransition_ShouldCallTranstionHandlerExecute()
        {
            ...
            // Act
            await _atsTransitionService.ExecuteTransitionAsync(transitionDataModel, transition);
